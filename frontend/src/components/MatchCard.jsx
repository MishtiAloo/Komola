...
function MatchCard ({opponent, matchImage, cup, date, time, venue}) {
    ...
    >
        ...
        <div style={{backgroundColor: 'orange', height: '60%', margin: '5px 5px 0px 5px', borderRadius: '13px', position: 'relative'}}>
        ...
        <div style={{backgroundColor: '#3B3B3B', borderRadius: '13px', margin: '5px 5px 5px 5px', lineHeight: '0.3', padding: '5px'}}>
            <p style={{fontWeight: '600'}}>Date: {date}</p>
            <p style={{fontWeight: '600'}}>Time: {time}</p>
            <p style={{fontWeight: '600'}}>Venue: {venue}</p>
